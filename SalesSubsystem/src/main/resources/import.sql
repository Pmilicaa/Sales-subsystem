...
INSERT INTO `businessinfodb`.`article` (`id`, `active`, `description`, `name`, `article_group_article`, `company_article`, `unit_of_measure_article`) VALUES (1, True, 'novi', 'novi', 1, 1, 1)
...
insert into price_list(id, valid_from, price_per_unit, article_price, company_price) values(1, '2012-01-01', 25.5, 1, 1)
